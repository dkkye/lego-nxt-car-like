...
(cl:defmethod cl:initialize-instance :after ((m <Position2DInt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position2DInt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carlike_local_planner-msg:<Position2DInt> is deprecated: use carlike_local_planner-msg:Position2DInt instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Position2DInt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carlike_local_planner-msg:x-val is deprecated.  Use carlike_local_planner-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Position2DInt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carlike_local_planner-msg:y-val is deprecated.  Use carlike_local_planner-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Position2DInt>)))
  ...
  "carlike_local_planner/Position2DInt")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Position2DInt)))
  "Returns string type for a message object of type 'Position2DInt"
  "carlike_local_planner/Position2DInt")
