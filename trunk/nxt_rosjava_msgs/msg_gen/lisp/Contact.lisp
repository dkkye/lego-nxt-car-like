...
(cl:defmethod cl:initialize-instance :after ((m <Contact>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contact)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_rosjava_msgs-msg:<Contact> is deprecated: use nxt_rosjava_msgs-msg:Contact instead.")))
...
(cl:defmethod contact-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_rosjava_msgs-msg:contact-val is deprecated.  Use nxt_rosjava_msgs-msg:contact instead.")
  (contact m))
